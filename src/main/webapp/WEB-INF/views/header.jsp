...
<header>
  ...
  <div class="banner">
    ...
    <div class="loginForm">
	  ...
	  <div class="lang">
		<a href="/MUBA/login/home.html?locale=en"><img class="flag" alt="<spring:message code="language.en"/>" src="/MUBA/resources/english.jpg"></a>
		<a href="/MUBA/login/home.html?locale=es_ES"><img class="flag" alt="<spring:message code="language.es"/>" src="/MUBA/resources/hispania.png"></a>
		<a href="/MUBA/login/home.html?locale=eu"><img class="flag" alt="<spring:message code="language.eu"/>" src="/MUBA/resources/euskera.png"></a>
	  </div>
