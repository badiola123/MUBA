...
<header>
    ...
    <div id="bot">
        <a href="/atlasr/myRobaks/page.html" class="btn btn-success" id="nav1">Moje robaki</a>
        <a href="/atlasr/robaksUser/page.html" class="btn btn-success" id="nav2">Robaki świata</a>
