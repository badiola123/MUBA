...
public class AccountController {
	 ...
	 * 
	 * @param oldPass Old password entered by the user to verify the identity
	 * @param newPass New password entered by the user which will replace the current password
	 * @param reNewPass New password retyped by the user to confirm it
