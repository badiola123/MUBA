...
<form action="/atlasr/myRobaks/addRobak.html" method="post" id="form">
    ...
    <input type="file" name="pic" class="form-control-file" accept="image/jpg" enctype="multipart/form-data" required>
